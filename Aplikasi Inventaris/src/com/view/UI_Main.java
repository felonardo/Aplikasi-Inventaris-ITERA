...
//    private static Fr_Beranda single_instance =null; 
    ...
    //Buat 1 objek Pinjam
      ...
      public static Fr_Pegawai getInstancePegawai(){
        if(single_instance_Pegawai == null){
            single_instance_Pegawai = new Fr_Pegawai();
        }  
          return single_instance_Pegawai;
      }
...
//        // TODO add your handling code here:
    ...
    private void PnlPegawaiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PnlPegawaiMouseClicked
        ...
        pnlBeranda.setBackground(Color.BLACK);
        Fr_Pegawai Pegawai = UI_Main.getInstancePegawai();
        BasicInternalFrameUI bi = (BasicInternalFrameUI)Pegawai.getUI();
        bi.setNorthPane(null);
